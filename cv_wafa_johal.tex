...
I work with robots having various embodiment and try to base my models on social sciences and cognitive sciences. 
...
I have conducted child-robot interaction experiments from protocol design to data analysis.
...
\item Özgür A., Lemaignan S., \textbf{Johal W.}, Mondada F. et al.. Cellulo: Versatile Handheld Robots for Education. \emph{ ACM/IEEE International Conference on Human-Robot Interaction} (HRI), 2017.
...
\item Organization Committee,
	...
	``Workshop on Social Robots in Education'' @NewFriends 2016,
	\href{https://socialrobotsineducation.wordpress.com/ }{https://socialrobotsineducation.wordpress.com/ }.
...
\textbf{Reviewer for: }
\begin{innerlist}
	\item[-] \emph{International Journal of Human-Robot Interaction},2016
	\item[-] \emph{International Journal of Social Robotics},2016
	\item[-] \emph{IEEE Robotics and Automation Magazine (IEEE-RAM)},2016
	\item[-] \emph{Journal of Cognitive Systems Research}, 2016
	\item[-] \emph{Journal on Interaction Studies}, 2016
	\item[-] \emph{Transaction on Learning Technologies}, 2017
